...
# 2 - [NOT YET IMPLEMENTED] Looks for a .ISO in the Source directory. This produces a large intunewin file and may both slow down deployments considerably whilst increasing azure storage costs!
$installSource = 0
